...
class WEN_Skill_Charts_Admin {
        ...
        <?php foreach ( $skills as $key => $skill ): ?>
          ...
          <div class="skill-item-wrap">
            ...
            <div class="wsc-form-row">
              <label><?php _e( 'Title', 'wen-skill-charts' ); ?></label>
              <input type="text" name="skill_title[]" value="<?php echo esc_attr( $skill['title'] ); ?>" placeholder="<?php _e( 'Enter Title', 'wen-skill-charts' ); ?>" class="txt-skill-title regular-text code" />
            ...
            <div class="wsc-form-row">
              <label><?php _e( 'Percentage', 'wen-skill-charts' ); ?></label>
              <input type="number" name="skill_percentage[]" value="<?php echo esc_attr( $skill['percentage'] ); ?>" placeholder="<?php _e( 'Enter Percentage', 'wen-skill-charts' ); ?>" class="txt-skill-percentage regular-text code" min="1" />
            ...
            <input type="button" value="<?php  esc_attr( _e( 'Remove', 'wen-skill-charts' ) ); ?>" class="button btn-remove-skill-item"/>
  ...
  function settings_meta_box_callback( $post ){
    ...
    <p><label><?php _e( 'Type', 'wen-skill-charts' ); ?></label>
      <select name="wen_skill_charts_settings[chart_type]">
        <?php
