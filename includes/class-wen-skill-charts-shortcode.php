    ...
    <div class="wen-skill-bar" id="<?php echo esc_attr( 'wsc-'.$skill_settings['random_id'] ); ?>">
      <?php foreach ( $skills as $key => $skill ): ?>
        ...
        <div class="skill-wrap">
          ...
          <div class="skill-description"><?php echo esc_html( $skill['description'] ); ?></div>
          <?php endif ?>
          <div class="skill-bar-wrap clearfix " data-percent="<?php echo esc_attr( $skill['percentage'] . '%' ); ?>">
            <div class="skill-bar" style="background: <?php echo esc_attr( $color ); ?>;"></div>
            <?php if ( 'disable' != $skill_settings['percentage_position'] ): ?>
            <div class="skill-percentage skill-percentage-position-<?php echo esc_attr( $skill_settings['percentage_position'] ); ?>" style="color:<?php echo esc_attr( $skill_settings['percentage_color'] ); ?>;"><?php echo esc_attr( $skill['percentage'] ); ?></div>
            <?php endif ?>
          </div>
          <?php if ( 'bottom' == $skill_settings['title_position'] ): ?>
          <div class="skill-title"><?php echo esc_html( $skill['title'] ); ?></div>
